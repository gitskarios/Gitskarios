...
public class GistsMainActivity extends BaseActivity implements GistsFragment.GistsFragmentListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (accounts.length > 0) {
            ...
            Intent intent = new Intent(GistsMainActivity.this, LoginActivity.class);
    ...
    private void createDrawer() {
        ...
        DrawerImageLoader.init(new DrawerImageLoader.IDrawerImageLoader() {
            ...
            public void set(ImageView imageView, Uri uri, Drawable placeholder) {
                Picasso.with(GistsMainActivity.this).load(uri).placeholder(placeholder).into(imageView);
            }
    ...
    private void selectAccount(Account account) {
        ...
        StoreCredentials credentials = new StoreCredentials(GistsMainActivity.this);
        credentials.clear();
