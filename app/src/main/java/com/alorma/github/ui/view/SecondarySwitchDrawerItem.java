...
public class SecondarySwitchDrawerItem extends BaseDrawerItem<SecondarySwitchDrawerItem> {
      ...
      new CompoundButton.OnCheckedChangeListener() {
        ...
        public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
          ...
          if (getOnCheckedChangeListener() != null) {
            getOnCheckedChangeListener().onCheckedChanged(SecondarySwitchDrawerItem.this,
  ...
  public SecondarySwitchDrawerItem withOnCheckedChangeListener(
  ...
  public void bindView(RecyclerView.ViewHolder holder) {
    ...
    UIUtils.setBackground(viewHolder.view,
        DrawerUIUtils.getSelectableBackground(ctx, selectedColor));
    ...
    ColorHolder.applyToOr(getDescriptionTextColor(), viewHolder.description,
    ...
    Drawable selectedIcon =
        ImageHolder.decideIcon(getSelectedIcon(), ctx, selectedIconColor, isIconTinted(), 1);
    ImageHolder.applyMultiIconTo(icon, iconColor, selectedIcon, selectedIconColor, isIconTinted(),
        viewHolder.icon);
  ...
  protected int getColor(Context ctx) {
    int color;
    if (this.isEnabled()) {
      color = ColorHolder.color(getTextColor(), ctx, R.attr.material_drawer_secondary_text,
