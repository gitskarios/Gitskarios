...
public class GistsAdapter extends RecyclerArrayAdapter<Gist, GistsAdapter.Holder> {
    ...
    protected void onBindViewHolder(Holder holder, Gist gist) {
        ...
        GistSmallFilesAdapter adapter =
                new GistSmallFilesAdapter(LayoutInflater.from(holder.files.getContext()));
    ...
    public class Holder extends RecyclerView.ViewHolder {
        ...
        public Holder(View itemView) {
            ...
            files.setLayoutManager(new LinearLayoutManager(files.getContext(),
