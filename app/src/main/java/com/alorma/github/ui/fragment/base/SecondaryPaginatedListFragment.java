...
public abstract class SecondaryPaginatedListFragment<K, T> extends SecondaryLoadingListFragment<T> implements BaseClient.OnResultCallback<K>, AbsListView.OnScrollListener {
