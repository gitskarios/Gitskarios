 ...
 */
public class NotificationsAdapter extends RecyclerArrayAdapter<Notification, NotificationsAdapter.ViewHolder> /*implements StickyListHeadersAdapter*/ {


    @Inject
    Bus bus;

    public NotificationsAdapter(LayoutInflater inflater) {
        super(inflater);
...
/*    @Override
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.text.setText(item.subject.title);
    }
