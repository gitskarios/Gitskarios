...
public class GithubLoginFragment extends Fragment {
  ...
  private void finishLogin(Uri uri) {
    ...
    if (requestTokenClient == null) {
      requestTokenClient =
          new RequestTokenClient(code, BuildConfig.CLIENT_ID, BuildConfig.CLIENT_SECRET,
  ...
  private void openExternalLogin() {
    ...
    if (browserList != null && !browserList.isEmpty()) {
      ...
      final Intent chooser =
          Intent.createChooser(new Intent(Intent.ACTION_VIEW, uri), "Choose your favorite browser");
  ...
  private void openAdvancedLogin(String url) {
    ...
    if (browserList != null && !browserList.isEmpty()) {
      ...
      final Intent chooser =
          Intent.createChooser(new Intent(Intent.ACTION_VIEW, Uri.parse(ADVANCED_URL)),
