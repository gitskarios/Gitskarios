...
public class IssueCommentPresenter extends BaseRxPresenter<EditIssueCommentBodyRequest, GithubComment, View<GithubComment>> {

  public IssueCommentPresenter(Scheduler mainScheduler, Scheduler ioScheduler,
