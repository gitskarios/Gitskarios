...
public class DeleteFileClient extends GithubClient<NewContentResponse> {

  private NewContentRequest newContentRequest;
  private final RepoInfo repoInfo;
  private final String path;

  public DeleteFileClient(NewContentRequest newContentRequest, RepoInfo repoInfo, String path) {
  ...
  protected Observable<NewContentResponse> getApiObservable(RestAdapter restAdapter) {
    ...
    return contentService.deleteFile(repoInfo.owner, repoInfo.name, path, newContentRequest);
  }
}
