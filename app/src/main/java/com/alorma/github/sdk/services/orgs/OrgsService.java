...
public interface OrgsService {
  ...
  void orgsByUser(@Path("orgName") String username, Callback<List<Organization>> callback);

  @GET("/user/orgs")
  void orgs(@Query("page") int page, Callback<List<Organization>> callback);

  @GET("/users/{orgName}/orgs")
  void orgsByUser(@Path("orgName") String username, @Query("page") int page, Callback<List<Organization>> callback);
  ...
  @GET("/users/{orgName}/orgs")
  List<Organization> orgsByUser(@Path("orgName") String username);

  @GET("/user/orgs")
  List<Organization> orgs(@Query("page") int page);

  @GET("/users/{orgName}/orgs")
  List<Organization> orgsByUser(@Path("orgName") String username, @Query("page") int page);
