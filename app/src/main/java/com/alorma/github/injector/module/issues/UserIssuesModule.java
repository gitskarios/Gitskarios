...
public class UserIssuesModule {
    ...
    @Provides
    @PerActivity
    CloudUsersIssuesDataSource provideCloudUsersIssuesDataSource(
            IssuesRetrofitWrapper retrofitWrapper) {
        return new CloudUsersIssuesDataSource(retrofitWrapper);
    }

    @Provides
    @PerActivity
    UserIssuesBaseRxPresenter provideUserIssuesBaseRxPresenter(
        ...
        return new UserIssuesBaseRxPresenter(
