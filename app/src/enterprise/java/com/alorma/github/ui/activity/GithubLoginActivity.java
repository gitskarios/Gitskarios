...
public class GithubLoginActivity extends AccountAuthenticatorActivity
  ...
  public void endAccess(String accessToken) {
    ...
    if (Fabric.isInitialized()) {
      EditText tokenText = ButterKnife.findById(this, R.id.accessToken);
      Answers.getInstance()
          .logLogin(new LoginEvent().putMethod(
              TextUtils.isEmpty(tokenText.getText()) ? "oauth" : "advanced").putSuccess(true));
    }
    ...
    authUserClient.observable()
        ...
        .subscribe(new Subscriber<Pair<User, String>>() {
          ...
          public void onError(Throwable e) {
            GithubLoginActivity.this.onError(e);
          }
