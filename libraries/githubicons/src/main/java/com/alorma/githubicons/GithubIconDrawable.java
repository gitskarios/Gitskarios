...
import static com.alorma.githubicons.GithubIconifyUtils.convertDpToPx;
import static com.alorma.githubicons.GithubIconifyUtils.isEnabled;
...
public class GithubIconDrawable extends Drawable {
     ...
     */
    public GithubIconDrawable(Context context, GithubIconify.IconValue icon) {
        this.context = context;
        this.icon = icon;
        paint = new TextPaint();
        paint.setTypeface(GithubIconify.getTypeface(context));
     ...
     * @return The current IconDrawable for chaining.
     */
    public GithubIconDrawable sizeRes(int dimenRes) {
     ...
     * @return The current IconDrawable for chaining.
     */
    public GithubIconDrawable sizeDp(int size) {
     ...
     * @return The current IconDrawable for chaining.
     */
    public GithubIconDrawable sizePx(int size) {
        this.size = size;
     ...
     * @return The current IconDrawable for chaining.
     */
    public GithubIconDrawable color(int color) {
     ...
     * @return The current IconDrawable for chaining.
     */
    public GithubIconDrawable colorRes(int colorRes) {
     ...
     * @return The current IconDrawable for chaining.
     */
    public GithubIconDrawable alpha(int alpha) {
        setAlpha(alpha);
        invalidateSelf();
        return this;
    }
